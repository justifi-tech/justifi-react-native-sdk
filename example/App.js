        ...
        switch (view) {
            case 'bankAccount':
                return (React.createElement(react_native_1.View, { style: styles.box },
                    ...
                    React.createElement(justifi_react_native_sdk_1.BankAccountForm, { style: { height: 200, width: '80%' }, styleOverrides: styleOverrides }),
                    React.createElement(react_native_1.View, null,
                        React.createElement(react_native_1.Button, { title: "Tokenize", onPress: handleTokenize }),
                        React.createElement(react_native_1.Button, { title: "Validate", onPress: handleValidate })),
                    React.createElement(react_native_1.Button, { title: "Back to Menu", onPress: () => setView('menu') })));
            case 'card':
                return (React.createElement(react_native_1.View, { style: styles.box },
            ...
            default:
                return (React.createElement(React.Fragment, null,
                    React.createElement(react_native_1.Button, { title: "Bank Account Form", onPress: () => setView('bankAccount') }),
                    React.createElement(react_native_1.Button, { title: "Card Form", onPress: () => setView('card') })));
        }
    };
    return React.createElement(react_native_1.View, { style: styles.container }, renderContent());
}
exports.default = App;
